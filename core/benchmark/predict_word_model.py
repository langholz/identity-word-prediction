...
def parse_arguments():
    ...
    parser.add_argument("--corpus_file_path", type = str, default = "ptb_word_corpus.pkl", help = "The file path to load the corpus constructed from the data")
    parser.add_argument("--model_file_path", type = str, default = "ptb_word_model.pt", help = "File path used to load the model")
...
def setup_context(config):
    ...
    context = ptb_processor.word_items_from_string(config.context)
