...
def parse_arguments():
    ...
    parser.add_argument("--corpus_file_path", type = str, default = "ptb_word_corpus.pkl", help = "The file path to save/load the corpus constructed from the data")
    ...
    parser.add_argument("--model_file_path", type = str, default = "ptb_word_model.pt", help = "File path used to save the model")
...
def setup_corpus(config):
    ...
    if (file_exists(config.corpus_file_path)):
        ...
        corpus = ptb_processor.process_corpus_as_words(corpus)
